...
export function ResourcePanel() {
  ...
  const resources = [
    ...
    { icon: <Globe className="w-5 h-5" />, value: Math.floor(gameState.resources.influence || 0), name: 'Influence', production: resourceProduction.influence, key: 'influence' },ey: 'influence' }
  ];
